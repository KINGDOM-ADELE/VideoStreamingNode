...
const PostVideoCrypto = () => {
  ...
  // const { API_base_url, isLoggedIn, getStoredToken } = useContext(AppContext)
  const { API_base_url, isLoggedIn, getStoredToken, encryptData, encryptedEncryptionKeyIvsuccesCriteriaArray } = useContext(AppContext);
  ...
  const handleFormSubmit = async (e) => {
    ...
    let encryptedFormData = await encryptData(JSON.stringify(formDataToSend));
    try {
      // Send POST request to your API endpoint
      let URL = `${API_base_url}api/v1/videos`
